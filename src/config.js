...
export const config = {
  ...
  profileCleanup: {
    ...
    pressureAdaptiveEnabled: parseBoolean(process.env.PROFILE_CLEANUP_PRESSURE_ADAPTIVE_ENABLED, true),
    pressureTargetPercent: parsePositiveInt(process.env.PROFILE_CLEANUP_PRESSURE_TARGET_PERCENT, 85),
    pressureIntervalMs: parsePositiveInt(process.env.PROFILE_CLEANUP_PRESSURE_INTERVAL_MINUTES, 5) * 60 * 1000,
    pressureStartupDelayMs: parseNonNegativeInt(process.env.PROFILE_CLEANUP_PRESSURE_STARTUP_DELAY_SECONDS, 10) * 1000,
    pressureMaxDeletePerRun: parsePositiveInt(process.env.PROFILE_CLEANUP_PRESSURE_MAX_DELETE_PER_RUN, 5000),
    ...
    backupCleanupEnabled: parseBoolean(
      process.env.PROFILE_CLEANUP_BACKUP_ENABLED,
      process.env.NODE_ENV === 'production'
    ),
    backupRoot: String(process.env.PROFILE_CLEANUP_BACKUP_ROOT || '').trim(),
    backupMinAgeMs: parsePositiveInt(process.env.PROFILE_CLEANUP_BACKUP_MIN_AGE_DAYS, 7) * 24 * 60 * 60 * 1000,
    backupMaxDeletePerRun: parsePositiveInt(process.env.PROFILE_CLEANUP_BACKUP_MAX_DELETE_PER_RUN, 10),
    backupAllowedPrefixes: parseEnvList(process.env.PROFILE_CLEANUP_BACKUP_ALLOWED_PREFIXES, ['reset-zero-']),
  },
  ...
  queue: {
    ...
    coldSessionClaimLimit: parseNonNegativeInt(process.env.MESSAGE_QUEUE_COLD_SESSION_CLAIM_LIMIT, 1),
    coldSessionMinAvailableSlots: parseNonNegativeInt(process.env.MESSAGE_QUEUE_COLD_SESSION_MIN_AVAILABLE_SLOTS, 2),
