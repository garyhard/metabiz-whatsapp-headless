...
export const config = {
  ...
  queue: {
    ...
    backpressureSweepIntervalMs: parsePositiveInt(process.env.MESSAGE_QUEUE_BACKPRESSURE_SWEEP_INTERVAL_MS, 30000),
    backpressureSweepSessionLimit: parsePositiveInt(process.env.MESSAGE_QUEUE_BACKPRESSURE_SWEEP_SESSION_LIMIT, 25),
